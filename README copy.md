...
[![NPM](https://img.shields.io/npm/v/sf-i-ticketing.svg)](https://www.npmjs.com/package/sf-i-ticketing) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)
...
- **Header & Footer** - SfITicketing component generates both the header and footer view
...
- **Search Input** - SfITicketing ships with a search input field
- **Social Media** - SfITicketing accepts social media links as an un-ordered list and renders them into the footer
- **Copyright Notice** - SfITicketing accepts copyright notice as input and renders it into the footer
...
- **Call-to-action Button** - SfITicketing comes with a call-to-action button, which can be used to highlight key actions such as sign in and subscribe.
...
- **Customizability** - SfITicketing colors can be customized using css custom properties
- **Responsiveness** - SfITicketing nicely adapts to all screen sizes
...
<html>
  <head>
    ...
    <title>&lt;sf-i-ticketing&gt; Demo</title>
    <!-- Integration material icons as they are used in sf-i-ticketing -->
    ...
    <!-- Integration lit and sf-i-ticketing web components module -->
    <script type="module">
        import {LitElement, html, css} from 'https://unpkg.com/lit-element/lit-element.js?module';
        import {SfITicketing} from 'https://unpkg.com/sf-i-ticketing/sf-i-ticketing.js?module';
    </script>
    <style>
  ...
  <body style="margin: 0px;">
    ...
    <script>
      document.getElementsByTagName('sf-i-ticketing')[0].addEventListener('searchClick', () => {console.log('hurray');})
      document.getElementsByTagName('sf-i-ticketing')[0].addEventListener('routeChange', (e) => {
...
Routing is enabled by default. Every hash link specified in the SfITicketing component needs to be backed by its separate html component. For example the links in the brand info section (above section), contains #home as the link. For routing to work, simply create a separate home.html component for it. SfITicketing will then automatically take care of routing.
...
Search Input is shown by default and the SfITicketing component throws a searchClick event after the user types something in the search input field and presses enter. To handle the searchClick event:

```html

    <script>
      document.getElementsByTagName('sf-i-ticketing')[0].addEventListener('searchClick', () => {console.log('search clicked');})
    </script>
